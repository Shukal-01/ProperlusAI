    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-12 bg-gradient-to-br from-primary/5 via-accent/5 to-transparent">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground">{service.overview}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              {/* Description */}
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold mb-4">Detailed Description</h2>
              ...
              {/* Tools */}
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold mb-6">Tools & Software</h2>
                <div className="flex flex-wrap gap-3">
              ...
              {/* Pricing */}
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold mb-6">Pricing (USD)</h2>
              ...
              {/* Growth */}
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold mb-6">Future Growth Options</h2>
                <div className="grid gap-3">
              ...
              <Card className="border-2 border-primary/20 sticky top-24">
                <CardContent className="pt-6 space-y-6">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Support</h3>
                      <p className="text-sm">{service.support}</p>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-accent text-white">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-xl mb-8 opacity-90">
            Let's discuss how this service can move your business forward.
          </p>
